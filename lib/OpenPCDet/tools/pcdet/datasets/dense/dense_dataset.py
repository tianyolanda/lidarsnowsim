...
def get_calib(sensor: str = 'hdl64'):
    calib_file = Path(__file__).parent.absolute().parent.parent.parent.parent / 'data' / 'dense' / f'calib_{sensor}.txt'
...
class DenseDataset(DatasetTemplate):
    ...
    def include_dense_data(self, mode, search_str):
        ...
        for info_path in self.dataset_cfg.INFO_PATH[mode]:
            ...
            info_file_name = info_path

            info_path = Path('/home/ubuntu/codes/2025codes/LiDAR_snow_sim/lib/OpenPCDet/data/dense/'+ info_file_name)
        ...
        # print('self.dense_infos',self.dense_infos)
        # print('dense_infos',dense_infos)
